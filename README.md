...
```bash
git clone https://github.com/SuyashPrasad03/RAG_project.git
cd RAG_project
```
...
🔗 [LinkedIn](https://www.linkedin.com/in/suyashprasad333/)  
🐙 [GitHub](https://github.com/SuyashPrasad03)
