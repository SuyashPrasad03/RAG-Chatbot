...
def preprocessing():
    ...
    paths = [
        "./suyash/numpy_docs.json",
        "./suyash/pandas_docs.json",
        "./suyash/scikit__docs.json",
        "./suyash/tensor__docs.json",
        "./suyash/torch__docs.json",
        "./suyash/matplot__docs.json",
        "./suyash/lgbm__docs.json",
        "./suyash/seaborn__docs.json",
        "./suyash/streamlit__docs.json",
        "./suyash/transformer__docs.json",
        "./suyash/xgb__docs.json"
            ]
    all_data = []
    for path in paths:
        try:
